...
public partial class MalumMenu : BasePlugin
{
    ...
    public static ConfigEntry<string> spamMessage;
    public static ConfigEntry<float> spamInterval;
    public static ConfigEntry<int> quickChatSpamID;
    ...
    public override void Load()
    {
        ...
        spamMessage = Config.Bind("MalumMenu.Chat",
                                ...
                                "Spam message for Spammer");

        spamInterval = Config.Bind("MalumMenu.Chat",
                                 "SpamInterval",
                                 2.1f,
                                 "The spam interval for Spammer. 2.1f is minimum for not kicking by AC");

        quickChatSpamID = Config.Bind("MalumMenu.Chat",
                                "QuickChatSpamID",
                                197,
                                "QuickChat message ID to spam (StringNames.cs)");
